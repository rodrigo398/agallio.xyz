...
Hallo semuanya! Di tulisan kali ini, saya akan menceritakan pengalaman saya saat menjadi seorang frontend engineering lead di sebuah perusahaan tanda tangan digital terbesar di Indonesia ([PrivyID](https://privy.id)), di usia yang cukup muda yaitu 20 tahun.
...
Namun, tuntutan perusahaan di tempat saya magang mengharuskan saya menggunakan library JavaScript modern, yaitu React.js. Jadi, saya diharuskan untuk bisa belajar dan beradaptasi dengan sangat cepat. Dan saya, yang pada waktu itu masih _anak ingusan_, merasa sangat kebingungan dan kesusahan.
...
- **Security, Performance, Accessibility & Usability Testing**<br/>
