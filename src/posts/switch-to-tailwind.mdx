...
Sekian pengalaman dan impresi pertama saya menggunakan Tailwind CSS. Buat teman-teman yang ingin melihat in-depth bagaimana blog ini ditulis ulang dengan Tailwind CSS, teman-teman bisa kunjungi di [GitHub](https://github.com/agallio/agall.io). Terima kasih sudah membaca, stay safe dan have a nice day 😁
